  ...
  return (
    <>
      <div className="sidebar-section flex flex-col">
        <div className="dashboard-title text-xl font-bold text-center mb-1">
          Omoi
        </div>
        <div className="sidebar-components">
          ...
          <p className="sidebar-component-section pt-5">Tools</p>
          <ul>
            <li className="sidebar-items">
              <svg
                className="sidebar-icons"
          ...
          <p className="sidebar-component-section pt-5">Projects</p>
          <ul>
            <li className="sidebar-items">
              <svg
                className="sidebar-icons"
