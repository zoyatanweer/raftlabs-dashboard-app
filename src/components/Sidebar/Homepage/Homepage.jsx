...
const Homepage = () => {
  return (
    <>
      <div className="homepage-section mr-2">
        <div className="homepage-avatar flex items-center mb-4">
          <svg
            className="homepage-icon mr-2 pr-2"
          ...
          <div className="flex flex-col">
            <div className="flex justify-between items-center">
              <h1 className="font-medium text-3xl mb-1">Good Evening Team!</h1>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
            ...
            {/* <h1 className="font-medium text-3xl mb-1">Good Evening Team!</h1> */}
            <p className="homepage-avatar-text text-grey-v2 font-semibold">
        ...
        <div className="homepage-monthly">
          <HomepageComponents />
        </div>
      </div>
    </>
